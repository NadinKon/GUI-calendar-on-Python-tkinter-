...
def fill():
    ...
    for n in range(week_day):
        ...
        days[week_day - n - 1]['fg'] = 'grey'
        days[week_day - n - 1]['bg'] = '#f3f3f3'

    for n in range(6 * 7 - month_day - week_day):
        days[week_day + month_day + n]['text'] = n + 1
        days[week_day + month_day + n]['fg'] = 'grey'
        days[week_day + month_day + n]['bg'] = '#f3f3f3'
